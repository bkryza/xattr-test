 ...
 */
template <typename T> bool base64_encode(const T &bindata, T &retval)
{
 ...
 */
template <typename T> bool base64_decode(const T &b64data, T &retval)
{
